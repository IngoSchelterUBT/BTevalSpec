...
def usage():
    ...
    print("  ./eval.py [--ext=<extern profile>] new <dipole files>")
    print("    Generates a new eval.yaml (or other) file based on the dipole-moment files")
    print("    Automatically groups the dipole-moment files into calculations and areas.")
    print("")
