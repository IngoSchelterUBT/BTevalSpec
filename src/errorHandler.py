...
def usage(cmd=""):
    ...
    if cmd in ["all","yaml"]:
        ...
        print("  - densft01.compact                #     Either as complex-valued BTcompact files")
    ...
    if cmd in ["all","decouple"]:
        ...
        print("")
        print("DENSFT:")
        print("  densft: #List of n(r,omega) at omega specified below")
        print("  #Using Gaussian cube files (real and imag parts)")
        print("  - [densft01r.cube, densft01i.cube]")
        print("  - [densft02r.cube, densft02i.cube]")
        print("  #OR complex-valued BTcompact files")
        print("  - btdft/densft01.compact")
        print("  - btdft/densft02.compact")
        print("    ...")
        print("  densen: #Actual omega [Ry] at which the FT densities above are given")
        print("  - 0.131990")
        print("  - 0.134330")
        print("    ...")
        print("  jcalc: 0")
