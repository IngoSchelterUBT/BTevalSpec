...
paste energy.dat energyErr.dat strength.dat strengthErr.dat signifFit.dat signifAng.dat signifExc.dat > $1.tmp
echo "# energy | energyErr | strength | strengthErr | signifFit | signifAng | signifExc" > $1.excit.dat
